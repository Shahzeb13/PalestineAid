...
<div className="navbar-logo-title" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginLeft: '16px' }}>
<img
...
style={{ width: '60px', height: '60px', objectFit: 'cover', borderRadius: '4px', marginRight: 0 }}
/>
<span className="navbar-title">
  <span style={{ color: '#000', fontWeight: 'bold' }}>Nusrah</span>
  <span style={{ color: '#009739', fontWeight: 'bold' }}>Pal</span>
  <span style={{ color: '#000', fontWeight: 'bold' }}>est</span>
  <span style={{ color: '#B10E20', fontWeight: 'bold' }}>ine</span>
</span>
</div>
